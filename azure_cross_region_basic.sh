#!/bin/bash
# =============================================================================
# Azure Cross-Region Basic Clusters deployment
# Usage: ./azure_cross_region_basic.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/Azure/Cross-Region/Basic_Clusters"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "Azure Cross-Region Basic Clusters - DESTROY"
else
    log_header "Azure Cross-Region Basic Clusters"
fi
