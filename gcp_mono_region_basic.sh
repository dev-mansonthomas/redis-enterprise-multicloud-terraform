#!/bin/bash
# =============================================================================
# GCP Mono-Region Basic Cluster deployment
# Usage: ./gcp_mono_region_basic.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/GCP/Mono-Region/Basic_Cluster"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "GCP Mono-Region Basic Cluster - DESTROY"
else
    log_header "GCP Mono-Region Basic Cluster"
fi
