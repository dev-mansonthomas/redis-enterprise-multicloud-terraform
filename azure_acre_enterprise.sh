#!/bin/bash
# =============================================================================
# Azure ACRE Enterprise deployment
# Usage: ./azure_acre_enterprise.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/Azure/ACRE/Enterprise"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "Azure ACRE Enterprise - DESTROY"
else
    log_header "Azure ACRE Enterprise"
fi
