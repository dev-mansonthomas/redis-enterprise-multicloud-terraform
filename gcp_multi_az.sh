#!/bin/bash
# =============================================================================
# GCP Mono-Region Rack-Aware Cluster deployment
# Usage: ./gcp_mono_region_rack_aware.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/GCP/Mono-Region/Rack_Aware_Cluster"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "GCP Mono-Region Rack-Aware Cluster - DESTROY"
else
    log_header "GCP Mono-Region Rack-Aware Cluster"
fi
