#!/bin/bash
# =============================================================================
# AWS Cross-Region Basic Clusters deployment
# Usage: ./aws_cross_region_basic.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/AWS/Cross-Region/Basic_Clusters"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "AWS Cross-Region Basic Clusters - DESTROY"
else
    log_header "AWS Cross-Region Basic Clusters"
fi
