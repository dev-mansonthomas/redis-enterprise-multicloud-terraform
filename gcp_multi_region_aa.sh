#!/bin/bash
# =============================================================================
# GCP Cross-Region Rack-Aware Clusters deployment
# Usage: ./gcp_cross_region_rack_aware.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/GCP/Cross-Region/Rack_Aware_Clusters"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "GCP Cross-Region Rack-Aware Clusters - DESTROY"
else
    log_header "GCP Cross-Region Rack-Aware Clusters"
fi
