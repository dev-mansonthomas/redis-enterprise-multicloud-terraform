#!/bin/bash
# =============================================================================
# GCP GKE Mono-Region Basic Cluster deployment
# Usage: ./gcp_gke_mono_region_basic.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/GCP/GKE/Mono-Region/Basic_Cluster"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "GCP GKE Mono-Region Basic Cluster - DESTROY"
else
    log_header "GCP GKE Mono-Region Basic Cluster"
fi
