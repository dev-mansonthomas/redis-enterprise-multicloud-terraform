...
# This script is located at: main/AWS/Cross-Region/Rack_Aware_Clusters/tofu_apply.sh
...
# Use script command to capture colors, filter noise but show important lines
