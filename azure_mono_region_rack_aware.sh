#!/bin/bash
# =============================================================================
# Azure Mono-Region Rack-Aware Cluster deployment
# Usage: ./azure_mono_region_rack_aware.sh [--destroy]
# =============================================================================
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "Azure Mono-Region Rack-Aware Cluster - DESTROY"
else
    log_header "Azure Mono-Region Rack-Aware Cluster"
fi
