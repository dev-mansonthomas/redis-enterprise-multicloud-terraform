#!/bin/bash
# =============================================================================
# Azure Mono-Region Basic Cluster deployment
# Usage: ./azure_mono_region_basic.sh [--destroy]
# =============================================================================
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "Azure Mono-Region Basic Cluster - DESTROY"
else
    log_header "Azure Mono-Region Basic Cluster"
fi
