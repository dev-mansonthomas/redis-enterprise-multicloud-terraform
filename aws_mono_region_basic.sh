#!/bin/bash
# =============================================================================
# AWS Mono-Region Basic Cluster deployment
# Usage: ./aws_mono_region_basic.sh [--destroy]
# =============================================================================
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "AWS Mono-Region Basic Cluster - DESTROY"
else
    log_header "AWS Mono-Region Basic Cluster"
fi
