#!/bin/bash
# =============================================================================
# GCP Cross-Region Basic Clusters deployment
# Usage: ./gcp_cross_region_basic.sh [--destroy]
# =============================================================================

CONFIG_DIR="main/GCP/Cross-Region/Basic_Clusters"
...
if [[ "$ACTION" == "destroy" ]]; then
    log_header "GCP Cross-Region Basic Clusters - DESTROY"
else
    log_header "GCP Cross-Region Basic Clusters"
fi
